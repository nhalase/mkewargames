    ...
    return (
      <Paper elevation={0}>
        <React.Fragment>
          ...
          <p>
            Milwaukee Wargames ("us", "we", or "our") operates the http://www.mkewar.games website (hereinafter referred
            to as the "Service").
          </p>

          <p>
            This page informs you of our policies regarding the collection, use, and disclosure of personal data when
            you use our Service and the choices you have associated with that data. The Privacy Policy for Milwaukee
            Wargames has been created with the help of{' '}
          ...
          <ul>
            <li>
              ...
              <p>Service is the http://www.mkewar.games website operated by Milwaukee Wargames</p>
            </li>
            <li>
              <p>
          ...
          <p>Milwaukee Wargames uses the collected data for various purposes:</p>
          <ul>
          ...
          <p>
            Milwaukee Wargames will take all steps reasonably necessary to ensure that your data is treated securely and
          ...
          <p>
            Milwaukee Wargames may disclose your Personal Data in the good faith belief that such action is necessary
            to:
          </p>
          <ul>
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of Milwaukee Wargames</li>
          ...
          <p>
            As an European citizen, under GDPR, you have certain individual rights. You can learn more about these
          ...
          <ul>
            <li>By email: contact@mkewar.games</li>
          </ul>
        </React.Fragment>
      </Paper>
    )
