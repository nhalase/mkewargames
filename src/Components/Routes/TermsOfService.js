      ...
      <Paper elevation={0}>
        <React.Fragment>
          ...
          <p>
            ...
            https://mkewar.games website (the "Service") operated by Milwaukee Wargames ("us", "we", or "our").
          </p>
          ...
          <p>
            ...
            the terms then you may not access the Service. The Terms and Conditions agreement for Milwaukee Wargames
          ...
          <p>
            Milwaukee Wargames has no control over, and assumes no responsibility for, the content, privacy
            policies, or practices of any third party web sites or services. You further acknowledge and agree that
            Milwaukee Wargames shall not be responsible or liable, directly or indirectly, for any damage or loss
          ...
          <p>
            These Terms shall be governed and construed in accordance with the laws of Wisconsin, United States,
